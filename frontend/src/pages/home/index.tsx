            ...
            <Box className={styles.main}>
                <Box className={styles.mainWrapper}>
                    <Box className={styles.children} display={'flex'} flexDirection={"column"} gap={2}>
                        ...
                        <Typography fontSize={16} fontWeight={600}>QuickPath:</Typography>
                        <Typography fontSize={14} fontWeight={400}>Streamline your warehouse operations with *QuickPath*, an advanced routing solution that reduces walking time by up to 70%. Experience faster order picking, improved efficiency, and higher productivity powered by intelligent algorithms tailored for two-dimensional warehouse models.</Typography>
                        <Typography fontSize={16} fontWeight={600}>Inventory Optimizer:</Typography>
                        <Typography fontSize={14} fontWeight={400}>Optimize your inventory like never before with *Inventory Optimizer*! Accurately predict seasonal demand and regional consumption patterns to eliminate overstocking and shortages. Maximize efficiency while minimizing waste for smarter, sustainable supply chain management.</Typography>
                    </Box>
                </Box>
            </Box>
        </Box>
